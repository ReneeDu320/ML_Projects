...
postive_lines = []
with open("/Users/karen/Desktop/613_project/code/data_train_pos.csv") as f1:
    postive_lines = [l for l in f1.readlines()]

negative_lines= []
with open("/Users/karen/Desktop/613_project/code/data_train_neg.csv") as f2:
    negative_lines = [l for l in f2.readlines()]
